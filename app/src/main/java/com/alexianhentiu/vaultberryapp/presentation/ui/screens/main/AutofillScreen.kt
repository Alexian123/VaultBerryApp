        ...
        is AutofillState.Idle -> {
            Column(
                ...
                ValidatedTextField(
                    ...
                    isValid = utilityViewModel.getFieldValidator(ValidatedFieldType.EMAIL),
                ...
                PasswordField(
                    ...
                    isValid = utilityViewModel.getFieldValidator(ValidatedFieldType.PASSWORD),
                    modifier = Modifier.fillMaxWidth()
                )
